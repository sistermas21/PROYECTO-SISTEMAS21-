...
$datos= consultaD($con, $sql,3)
  ...
  ?>
    ...
    <form action="Formularioventaprafecha2.php" target="_blank" method="post" id="compra_mes" name="form" class="navbar-form">
    <h3><b>REPORTE DE VENTAS POR FECHAS </b></h3>
    <br><br><br><br>
...
<input type="hidden" name="carnet" value="<?php print $datos[0][1]?>">
</td>
</tr>
<tr>
<td>
<!--Nombre:-->
<td>
<input type="hidden" name="nombre" value="<?php print $datos[0][2]?>_<?php print $datos[0][3]?>">
</td>
</tr>
<tr>
<td>
<!--Telefono:-->
<td>
<input type="hidden" name="telefono" value="<?php print $datos[0][6]?>">
</td>
</tr>
<tr>
<td>
<!--Domicilio:-->
<td>
<input type="hidden" name="domicilio" value="<?php print $datos[0][7]?>">
</td>
</tr>
</table>
<style type="text/css">
...
<tr>
<td>
<?php print $datos[0][2]?>_<?php print $datos[0][3]?>
</td>
</tr>
