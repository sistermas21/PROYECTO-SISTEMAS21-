...
<!--menu-->
   ...
   <article id="formulario">
<form action="ventasporfecha.php" method="post" id="cons" name="form" class="navbar-form">
    <fieldset>
...
if (!isset($_REQUEST['buscar'])) {
  ...
  print imprimetablaF1($datos,"./buscardetalle/Detalle11","table table-bordered table-striped",2,TRUE);

 }else {

$sql="SELECT f.id as Numero,f.numerofactura as '#Factura',f.carnetusuario as 'Carnet Vendedor'";
$sql.=",f.fechaventa as 'Fecha de Venta',u.nombre as 'Nombre Vendedor'";
$sql.=",u.apellido as 'Apellido Vendedor' FROM facturaventa f INNER JOIN usuario u ON f.carnetusuario=u.carnet WHERE f.fechaventa between '$fecha' AND '$fecha1' ORDER BY f.id asc";
$datos=consultaD($con,$sql);
print imprimetablaF($datos,"./buscardetalle/Detalle11","table table-bordered table-striped",2,TRUE);
print"<a id='lin' href='ventasporfecha.php'>Ver Listado de Facturas</a><legend id='linea'></legend>";
