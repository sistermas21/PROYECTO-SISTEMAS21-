...
?>
<?php
$sql ="SELECT * FROM proveedor WHERE id='".$_REQUEST['id']."';";
...
<!--menu-->
    ...
    <form action="../Actualizaciones/modificarproveedor.php" method="POST" id="proveedor" name="proveedor"  class="navbar-form">
   
    <fieldset> <LEGEND ><H3 ><p>Modificar Proveedor</p></H3></LEGEND>
    ...
    <table class="table">
      ...
      <tr>
        ...
        <input type="hidden" name="id" value='<?php print $datos[0][0]?>'>
          <input type="text" Placeholder="ejemplo: 35897895"  name="codigo" id="codigo" value='<?php print $datos[0][1]?>' required class="required digits">
          </td>
      </tr>
      ...
      <tr>
        ...
        <td>
        <input type="text" Placeholder="ejemplo:Yuton" name="nombre" id="nombre"value='<?php print $datos[0][2]?>'required  class="required form-control">
          </td>
      </tr>
      ...
      <tr>
        ...
        <td>
          <input type="text" Placeholder="Digite el E-mail" id="email" name="email"value='<?php print $datos[0][3]?>'required  class="required email">
          </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <input type="text" Placeholder="ejemplo:78682000" name="telefono" id="telefono"value='<?php print $datos[0][4]?>'required  class="required digits ">
          </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <input type="text"  Placeholder="Digite la derecci&oacute;n" name="direccion" id="dir"value='<?php print $datos[0][5]?>'required  class="required">
          </td>
      </tr>
