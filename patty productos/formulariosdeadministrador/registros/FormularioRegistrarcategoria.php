...
<!--menu-->
    ...
    <form action="classCategoria/manejadorCategoria.php?accion=save" name="categoria" method="POST" id="categoria" class="navbar-form">
   
    <fieldset>
         <legend><H3 ><p><i><b>Registrar Categoria</b></i></p></H3></legend>
    ...
    <table class="table">
			...
			<tr>
				...
				<td>
					<input type="text" Placeholder="21345" name="codigo" required  class="required digits form-control">
					</td>
			</tr>
			<tr>
				<td>
				...
				<td>
				<input type="text" Placeholder="lapices"  name="nombre" required class="required  form-control" >
					</td>
			</tr>
