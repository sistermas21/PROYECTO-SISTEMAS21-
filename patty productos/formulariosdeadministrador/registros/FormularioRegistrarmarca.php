...
<html lang="en">
  <head>
    ...
    <link href="Validacion/ventana.css" rel="stylesheet" type="text/css" />
...
<!--menu-->
    ...
    <form action="./classmarca/manejadormarca.php?accion=save" method="post" id="Marca" name="Marca" class="navbar-form">
   
    <fieldset>
     <legend><H3 ><p><i><b>Registrar Marca</b></i></p></H3></legend>
    ...
    <table class="table">		
        ...
        <td>
          <input type="text" Placeholder="ejemplo: 35897895" name="codigoM" required class="required digits" >
          </td>
      </tr>
        ...
        <td>
        <input type="text" Placeholder="ejemplo: "   name="nombreM"   required>
          </td>
      </tr>
        ...
        <button type="submit"  class="btn btn-sm btn-success"   name="btnM">Guardar</button>
          </td>
