<html><script type="text/javascript" language="javascript" src="jslistadopaises.js"></script>
...
//-------- factura compra --------//
  ...
  case "INSERT":
    ...
    if ($fila==0){
            ...
            print '<p>Mensaje: No se ha Podido Guardar la Factura de Compra...!Esa Factura de Compra  ya Existe!';
            print '<span class="badge glyphicon glyphicon-ok"></span></p>';
             print '<a href=\'facturacompra1.php.\'>Nueva Factura</a>';
            print "</div>";
    } 
      else{
      print '<html>
                <head>
                <meta http-equiv="REFRESH" content="0;url=facturacompra2.php?numfactura='.$_REQUEST['numf'].'">
                <head>
                </html>';
    }
...
function imprimetabla($objeto,$form,$estilo="table",$id,$editar=0){
  if ($objeto != NULL) {
    if (is_array($objeto)) {
      $tabla = "<table class=\"$estilo\"  id=\"$id\">";
      $tabla .= "<tr class='info'>";
