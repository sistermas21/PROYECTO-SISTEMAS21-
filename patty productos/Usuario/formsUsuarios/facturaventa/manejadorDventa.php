...
include 'detallefacturaventa.php';
include 'controladorDventa.php';
$ventA = new ventaDcontrolador();       
        if(isset($_REQUEST['bot'])){
          //guardamos datos
          $ventA->setId('NULL');
          $ventA->setNumerofactura($_REQUEST['numfactura']);
          $ventA->setCodpro($_REQUEST['codigo']);
...
print'<html>
                ...
                <head>
                <meta http-equiv="REFRESH" content="0;url=facturaventa2.php?numfactura='.$od.'">
                <head>
                </html>';
